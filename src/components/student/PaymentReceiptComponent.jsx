                                    ...
                                    {student.discount_amount > 0 && (
                                        <>
                                            <div className="flex justify-between text-red-600">
                                                <span>
                                                    ডিসকাউন্ট ({student.discount_type === 'percentage' ? `${student.discount_value}%` : 'Fixed'}):
                                                </span>
                            ...
                            {student.discount_amount > 0 && student.discount_reason && (
                                <div className="mb-4 p-3 bg-blue-50 border-l-4 border-blue-500 rounded">
                                    ...
                                    <p className="text-sm font-medium text-slate-700">
                                        {student.discount_type === 'percentage' ? `${student.discount_value}%` : `৳${student.discount_value}`} ডিসকাউন্ট প্রয়োগ করা হয়েছে - 
                                        {student.discount_reason === 'special_offer' && ' বিশেষ অফার'}
                                        {student.discount_reason === 'financial_support' && ' আর্থিক সহায়তা'}
                                        {student.discount_reason === 'ramadan_offer' && ' রমজান বিশেষ অফার'}
                                        {student.discount_reason === 'early_batch' && ' আর্লি ব্যাচ অফার'}
                                        {student.discount_reason === 'authority_approved' && ' কর্তৃপক্ষ অনুমোদিত বিশেষ ছাড়'}
                                        {student.discount_reason === 'custom' && ' বিশেষ ছাড়'}
                                    </p>
                                </div>
                            )}
